# https://github.com/cloneofsimo/minDiffusion/blob/master/train_cifar10.py
...
def train_cifar10(n_epoch: int = 100, device: str = "cuda:1", load_pth: Optional[str] = None) -> None:
